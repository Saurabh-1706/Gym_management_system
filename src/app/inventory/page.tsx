  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] text-[#e5e2e1] px-4 sm:px-6 lg:px-8 py-6 space-y-6 font-body">
      ...
      <div className="flex flex-col gap-4 sm:gap-5 md:flex-row md:items-center md:justify-between mb-4 sm:mb-6 lg:mb-8">
        ...
        <div className="flex sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center">
          ...
          <button
            ...
            className="btn-primary flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl font-headline text-xl tracking-wider text-white shadow cursor-pointer uppercase whitespace-nowrap"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
        <div className="glass-card rounded-2xl border border-zinc-800 px-5 py-4 flex flex-col shadow-lg text-left">
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-3">
          <div className="glass-card p-6 sm:p-8 rounded-2xl w-full max-w-md shadow-2xl border border-zinc-800 text-left">
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-3">
          <div className="glass-card p-6 sm:p-8 rounded-2xl max-w-md w-full shadow-2xl border border-zinc-800 text-center text-[#e5e2e1]">
