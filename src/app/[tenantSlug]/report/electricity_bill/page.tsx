    ...
    <div className="min-h-screen bg-[#0F0F0F] text-[#e5e2e1] px-4 sm:px-6 lg:px-8 py-6 space-y-6 font-body text-left">
                    ...
                    <td className="px-6 py-3.5">
                      <div className="flex justify-center">
                        <button
                          ...
                          className="btn-secondary px-4 py-1.5 rounded-lg font-headline text-sm tracking-wider text-white shadow cursor-pointer uppercase flex items-center gap-1.5"
                        >
                          <Edit size={14} /> Edit
                        </button>
                      </div>
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/60 px-3">
          <div className="glass-card p-6 sm:p-8 rounded-2xl max-w-lg w-[95%] sm:w-full border-[#2A2A2A] text-left">
