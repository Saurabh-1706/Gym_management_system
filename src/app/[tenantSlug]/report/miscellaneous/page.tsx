  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] text-[#e5e2e1] px-4 sm:px-6 lg:px-8 py-6 space-y-6 font-body text-left">
      ...
      <div className="flex flex-col gap-4 sm:gap-5 md:flex-row md:items-center md:justify-between mb-4 sm:mb-6 lg:mb-8">
        ...
        <button
          onClick={() => openModal()}
          className="btn-primary flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg font-headline text-xl tracking-wider text-white shadow cursor-pointer uppercase whitespace-nowrap"
        >
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex justify-center gap-2 sm:gap-3">
                          <button
                            onClick={() => openModal(c)}
                            className="btn-secondary px-3 py-1.5 rounded-lg font-headline text-xs tracking-wider text-white shadow cursor-pointer uppercase flex items-center gap-1"
                          >
                            <Edit size={14} /> Edit
                          </button>
                          <button
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/60 px-3">
          <div className="glass-card p-6 sm:p-8 rounded-2xl max-w-md w-[90%] sm:w-full border-[#2A2A2A] text-left">
      ...
      {deleteId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/60 px-3">
          <div className="glass-card p-6 sm:p-8 rounded-2xl max-w-md w-[90%] sm:w-full border-[#2A2A2A] text-center text-[#e5e2e1]">
