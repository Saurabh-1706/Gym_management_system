      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-6">
                      ...
                      {overdueMembers.map((m, idx) => {
                        ...
                        return (
                          <tr
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              router.push(`/${tenantSlug}/members/${m._id}`);
                            }}
                          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          <div
            ...
            onClick={() => router.push(`/${tenantSlug}/members`)}
          >
          ...
          <div
            className="glass-card rounded-xl p-6 relative overflow-hidden group cursor-pointer"
            onClick={() => router.push(`/${tenantSlug}/expiringsoon`)}
          >
            <div className="flex justify-between items-start mb-4">
          ...
          <div
            className="glass-card rounded-xl p-6 relative overflow-hidden group cursor-pointer"
            onClick={() => router.push(`/${tenantSlug}/expiredmembers`)}
          >
            <div className="flex justify-between items-start mb-4">
          ...
          <div
            className="glass-card rounded-xl p-6 relative overflow-hidden group cursor-pointer"
            onClick={() => router.push(`/${tenantSlug}/revenue`)}
          >
            <div className="flex justify-between items-start mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 glass-card rounded-xl p-6 sm:p-8">
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            <div className="glass-card rounded-xl p-6 flex flex-col h-full">
              ...
              <div className="flex flex-col gap-3 font-body">
                <button
                  onClick={() => router.push(`/${tenantSlug}/registration`)}
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border-[#2A2A2A] text-left text-sm font-semibold hover:border-[#f97316] hover:bg-white/10 hover:text-white transition flex items-center justify-between group cursor-pointer"
                >
                  <span>REGISTER NEW MEMBER</span>
                  <span className="text-[#f97316] group-hover:translate-x-1 transition-transform">→</span>
                </button>
                <button
                  onClick={() => router.push(`/${tenantSlug}/plan`)}
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border-[#2A2A2A] text-left text-sm font-semibold hover:border-[#f97316] hover:bg-white/10 hover:text-white transition flex items-center justify-between group cursor-pointer"
                >
                ...
                <button
                  onClick={() => router.push(`/${tenantSlug}/coach`)}
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border-[#2A2A2A] text-left text-sm font-semibold hover:border-[#f97316] hover:bg-white/10 hover:text-white transition flex items-center justify-between group cursor-pointer"
                >
